...
/*	if (double_buffer)
	...
	const char* russianFilename = "/usr/lib/enigma2/python/Plugins/Extensions/RussianMediaPark/plugin.pyo";
	if (::access(russianFilename, R_OK) >= 0)
	{
		eFatal("RussianMediaPark found! please remove RussianMediaPark!");;
	}
